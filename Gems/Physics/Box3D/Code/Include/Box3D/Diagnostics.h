...
namespace Box3D
{
    ...
    public:
        ...
        [[nodiscard]]
        virtual ReplayInfo GetInfo() const = 0;
        ...
        [[nodiscard]]
        virtual AZ::u32 GetFrame() const = 0;
        ...
        [[nodiscard]]
        virtual AZ::s32 GetDivergenceFrame() const = 0;

        virtual void SetWorkerCount(AZ::u32 workerCount) = 0;

        virtual void SetKeyframePolicy(
            size_t budgetBytes,
            AZ::u32 minimumInterval) = 0;

        [[nodiscard]]
        virtual size_t GetKeyframeBudget() const = 0;

        [[nodiscard]]
        virtual AZ::u32 GetMinimumKeyframeInterval() const = 0;

        [[nodiscard]]
        virtual AZ::u32 GetKeyframeInterval() const = 0;

        [[nodiscard]]
        virtual size_t GetKeyframeBytes() const = 0;

        [[nodiscard]]
        virtual AZ::u32 GetBodyCount() const = 0;

        [[nodiscard]]
        virtual bool GetBody(
            AZ::u32 index,
            ReplayBody& body) const = 0;

        [[nodiscard]]
        virtual AZ::u32 GetFrameQueryCount() const = 0;

        [[nodiscard]]
        virtual bool GetFrameQuery(
            AZ::u32 index,
            ReplayQuery& query) const = 0;

        [[nodiscard]]
        virtual bool GetFrameQueryHit(
            AZ::u32 queryIndex,
            AZ::u32 hitIndex,
            ReplayQueryHit& hit) const = 0;
    ...
    public:
        ...
        virtual bool StartRecording(
            WorldHandle worldHandle,
            size_t initialCapacityBytes = 0) = 0;

        [[nodiscard]]
        virtual bool StopRecording(
            WorldHandle worldHandle,
            AZStd::vector<AZ::u8>& data) = 0;

        [[nodiscard]]
        virtual bool ValidateRecording(
            AZStd::span<const AZ::u8> data,
            AZ::u32 workerCount = 1) const = 0;

        [[nodiscard]]
        virtual AZStd::unique_ptr<IReplay> CreateReplay(
            AZStd::span<const AZ::u8> data,
            AZ::u32 workerCount = 1) const = 0;
        ...
        virtual bool DrawWorld(
            WorldHandle worldHandle,
            const DebugDrawSettings& settings,
            IDebugRenderer& renderer) const = 0;
