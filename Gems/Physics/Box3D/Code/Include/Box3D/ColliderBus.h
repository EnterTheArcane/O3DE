...
namespace Box3D
{
    ...
    public:
        [[nodiscard]]
        virtual AZStd::span<const ShapeConfiguration> GetShapeConfigurations() const = 0;
        ...
        virtual bool UpdateTriangleMesh(
            size_t index,
        ...
        virtual bool UpdateHeightfield(
            size_t index,
        ...
        virtual bool SetCollisionFilter(
            size_t index,
