...
namespace Box3D
{
    ...
    public:
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookSphere(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookCapsule(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookBox(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookCylinder(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookConvexHull(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookTriangleMesh(
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookHeightfield(
            const HeightfieldShapeConfiguration& geometry,
            const ShapeProperties& properties)
        {
            return CookShape(ShapeConfiguration{geometry, properties});
        }
        ...
        [[nodiscard]]
        virtual CookedShapeHandle CookCompound(
            const CompoundShapeConfiguration& geometry,
            const ShapeProperties& properties)
        {
            return CookShape(ShapeConfiguration{geometry, properties});
        }
        ...
        [[nodiscard]]
        virtual bool IsCookedShapeValid(CookedShapeHandle cookedShapeHandle) const = 0;

        [[nodiscard]]
        virtual AZ::Aabb GetCookedShapeAabb(CookedShapeHandle cookedShapeHandle) const = 0;

        [[nodiscard]]
        virtual CookedRaycastResult RaycastCookedShape(
