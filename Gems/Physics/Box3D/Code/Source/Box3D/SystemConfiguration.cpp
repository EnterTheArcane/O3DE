...
namespace Box3D
{
    ...
    bool SystemConfiguration::operator==(
        const SystemConfiguration& other) const
    {
        return m_subStepCount == other.m_subStepCount
            && m_workerCount == other.m_workerCount
            && m_contactHertz == other.m_contactHertz
            && m_contactDampingRatio == other.m_contactDampingRatio
            && m_contactSpeed == other.m_contactSpeed
            && m_contactRecycleDistance == other.m_contactRecycleDistance
            && m_restitutionThreshold == other.m_restitutionThreshold
            && m_hitEventThreshold == other.m_hitEventThreshold
            && m_maximumLinearSpeed == other.m_maximumLinearSpeed
            && m_lengthUnitsPerMeter == other.m_lengthUnitsPerMeter
            && m_stallWarningThresholdSeconds == other.m_stallWarningThresholdSeconds
            && m_staticShapeCapacity == other.m_staticShapeCapacity
            && m_dynamicShapeCapacity == other.m_dynamicShapeCapacity
            && m_staticBodyCapacity == other.m_staticBodyCapacity
            && m_dynamicBodyCapacity == other.m_dynamicBodyCapacity
            && m_contactCapacity == other.m_contactCapacity
            && m_frictionCallback == other.m_frictionCallback
            && m_restitutionCallback == other.m_restitutionCallback
            && m_enableSleep == other.m_enableSleep
            && m_enableContinuous == other.m_enableContinuous
            && m_enableWarmStarting == other.m_enableWarmStarting
