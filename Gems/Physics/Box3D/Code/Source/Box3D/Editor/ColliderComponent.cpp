...
namespace Box3D::Editor
{
        ...
        AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            {
                editContext
                    ->Class<ColliderComponent>(QT_TRANSLATE_NOOP("Box3D", "Box3D Collider"), QT_TRANSLATE_NOOP("Box3D", "Adds one or more collision shapes to a Box3D body."))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Category, "Box3D")
                    ->Attribute(AZ::Edit::Attributes::AppearsInAddComponentMenu, AZ_CRC_CE("Game"))
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &ColliderComponent::m_shapes, QT_TRANSLATE_NOOP("Box3D", "Shapes"), QT_TRANSLATE_NOOP("Box3D", "Geometry, materials, filtering, and event policy."))
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &ColliderComponent::ConfigurationChanged)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &ColliderComponent::m_activeShapeIndex, QT_TRANSLATE_NOOP("Box3D", "Active shape"), QT_TRANSLATE_NOOP("Box3D", "Zero-based index of the shape edited by component mode."))
                    ->Attribute(AZ::Edit::Attributes::Min, 0)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &ColliderComponent::ConfigurationChanged)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &ColliderComponent::m_componentModeDelegate, QT_TRANSLATE_NOOP("Box3D", "Component mode"), QT_TRANSLATE_NOOP("Box3D", "Edit the active primitive shape in the viewport."))
    ...
    void ColliderComponent::Activate()
    {
        ...
        m_componentModeDelegate.SetAddComponentModeCallback(
            [this](const AZ::EntityComponentIdPair& pair)
            {
                ...
                {
                    const auto builder =
                        AzToolsFramework::ComponentModeFramework::CreateComponentModeBuilder<ColliderComponent, AzToolsFramework::SphereComponentMode>(pair, allowAsymmetricalEditing);
                ...
                {
                    const auto builder =
                        AzToolsFramework::ComponentModeFramework::CreateComponentModeBuilder<ColliderComponent, AzToolsFramework::CapsuleComponentMode>(pair, allowAsymmetricalEditing);
                    AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequestBus::Broadcast(
                        &AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequests::AddComponentModes,
                        AzToolsFramework::ComponentModeFramework::EntityAndComponentModeBuilders(pair.GetEntityId(), builder));
                    return;
                ...
                {
                    const auto builder =
                        AzToolsFramework::ComponentModeFramework::CreateComponentModeBuilder<ColliderComponent, AzToolsFramework::BoxComponentMode>(pair, allowAsymmetricalEditing);
                    AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequestBus::Broadcast(
                        &AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequests::AddComponentModes,
                        AzToolsFramework::ComponentModeFramework::EntityAndComponentModeBuilders(pair.GetEntityId(), builder));
                    return;
                ...
                {
                    const auto builder =
                        AzToolsFramework::ComponentModeFramework::CreateComponentModeBuilder<ColliderComponent, AzToolsFramework::CylinderComponentMode>(pair, allowAsymmetricalEditing);
                    AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequestBus::Broadcast(
                        &AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequests::AddComponentModes,
                        AzToolsFramework::ComponentModeFramework::EntityAndComponentModeBuilders(pair.GetEntityId(), builder));
                    return;
                ...
                const auto builder =
                    AzToolsFramework::ComponentModeFramework::CreateComponentModeBuilder<ColliderComponent, ComponentModes::OffsetComponentMode>(pair);
                AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequestBus::Broadcast(
                    &AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequests::AddComponentModes,
                    AzToolsFramework::ComponentModeFramework::EntityAndComponentModeBuilders(pair.GetEntityId(), builder));
            });
    ...
    AZ::Vector3 ColliderComponent::GetDimensions() const
    {
        ...
        if (box)
        {
            return 2.0f * box->m_halfExtents * shape.m_properties.m_localTransform.GetUniformScale();
        }
    ...
    AZ::Transform ColliderComponent::GetCurrentLocalTransform() const
    {
        if (m_activeShapeIndex < m_shapes.size())
        {
            return m_shapes[m_activeShapeIndex].m_properties.m_localTransform;
        }
