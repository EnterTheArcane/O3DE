...
namespace Box3D::Editor
{
        ...
        AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext
                ->Class<ExplosionComponent, AzToolsFramework::Components::EditorComponentBase>()
    ...
    void ExplosionComponent::BuildGameEntity(
        ...
        AzFramework::DebugDisplayRequests& debugDisplay)
    {
        ...
        debugDisplay.DrawWireSphere(
            GetWorldTM().TransformPoint(m_configuration.m_position),
            AZStd::abs(GetWorldTM().GetUniformScale()) * m_configuration.m_radius);
    }
    ...
    AZ::Aabb ExplosionComponent::GetEditorSelectionBoundsViewport(
        [[maybe_unused]] const AzFramework::ViewportInfo& viewportInfo)
    {
    ...
    void ExplosionComponent::SetRadius(
        const float radius)
    {
    ...
    void ExplosionComponent::SetTranslationOffset(
        ...
        AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext
                ->Class<WindComponent, AzToolsFramework::Components::EditorComponentBase>()
    ...
    void WindComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
    ...
    AZ::Aabb WindComponent::GetEditorSelectionBoundsViewport(
        [[maybe_unused]] const AzFramework::ViewportInfo& viewportInfo)
    {
        const AZ::Vector3 start = GetWorldTM().GetTranslation();
        AZ::Aabb bounds =
    ...
    void WindComponent::SetTranslationOffset(
        const AZ::Vector3& translationOffset)
    {
        if (!translationOffset.IsFinite())
        {
