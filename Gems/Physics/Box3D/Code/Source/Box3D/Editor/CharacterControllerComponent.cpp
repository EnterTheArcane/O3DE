...
namespace Box3D::Editor
{
        ...
        AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            {
                editContext
                    ->Class<CharacterControllerComponent>(QT_TRANSLATE_NOOP("Box3D", "Box3D Character Controller"), QT_TRANSLATE_NOOP("Box3D", "Moves a capsule through the physics scene with collision-aware sliding."))
                    ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Category, "Box3D")
                    ->Attribute(AZ::Edit::Attributes::AppearsInAddComponentMenu, AZ_CRC_CE("Game"))
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CharacterControllerComponent::m_worldName, QT_TRANSLATE_NOOP("Box3D", "World"), QT_TRANSLATE_NOOP("Box3D", "An empty name selects the default world."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CharacterControllerComponent::m_configuration, QT_TRANSLATE_NOOP("Box3D", "Movement"), QT_TRANSLATE_NOOP("Box3D", "Filtering, speed, slope, step, and update settings."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::ChangeNotify, &CharacterControllerComponent::ConfigurationChanged)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CharacterControllerComponent::m_componentModeDelegate, QT_TRANSLATE_NOOP("Box3D", "Component mode"), QT_TRANSLATE_NOOP("Box3D", "Edit capsule height and radius in the viewport."))
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly);
            }
        }
    }
    ...
    {
        AZ::Vector3 up = m_configuration.m_upDirection.GetNormalizedSafe();
        if (m_configuration.m_upDirection.IsZero())
        {
            up = AZ::Vector3::CreateAxisZ();
        }
    ...
    void CharacterControllerComponent::SetRadius(
        const float radius)
    {
    ...
    void CharacterControllerComponent::SetHeight(
        const float height)
    {
    ...
    void CharacterControllerComponent::SetTranslationOffset(
        [[maybe_unused]] const AZ::Vector3& translationOffset)
    {
    }
