...
namespace Box3D::Editor
{
    ...
    AZ::Aabb JointComponentBase::GetEditorSelectionBoundsViewport(
        [[maybe_unused]] const AzFramework::ViewportInfo& viewportInfo)
    {
        const JointCommonConfiguration& configuration = GetCommonConfiguration();
        const AZ::Transform childFrame = GetWorldTM() * configuration.m_childLocalFrame;
    ...
    void JointComponentBase::Reflect(
        AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext
                ->Class<JointComponentBase, AzToolsFramework::Components::EditorComponentBase>()
            ...
            if (auto* editContext = serializeContext->GetEditContext())
            {
                editContext->Class<JointCommonConfiguration>("Joint", "Settings shared by every joint type.")
                    ...
                    ->DataElement(AZ::Edit::UIHandlers::Default, &JointCommonConfiguration::m_parentLocalFrame, QT_TRANSLATE_NOOP("Box3D", "Parent local frame"), QT_TRANSLATE_NOOP("Box3D", "Joint frame relative to the parent body origin."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &JointCommonConfiguration::m_childLocalFrame, QT_TRANSLATE_NOOP("Box3D", "Child local frame"), QT_TRANSLATE_NOOP("Box3D", "Joint frame relative to this body origin."))
                    ->DataElement(AZ::Edit::UIHandlers::Default, &JointCommonConfiguration::m_forceThreshold, QT_TRANSLATE_NOOP("Box3D", "Force threshold"), QT_TRANSLATE_NOOP("Box3D", "Constraint force that raises the threshold event."))
    ...
    void JointComponentBase::GetProvidedServices(
        AZ::ComponentDescriptor::DependencyArrayType& provided)
    {
        Box3D::JointComponent::GetProvidedServices(provided);
    }

    void JointComponentBase::GetIncompatibleServices(
        AZ::ComponentDescriptor::DependencyArrayType& incompatible)
    {
        Box3D::JointComponent::GetIncompatibleServices(incompatible);
    }

    void JointComponentBase::GetRequiredServices(
        AZ::ComponentDescriptor::DependencyArrayType& required)
    {
        Box3D::JointComponent::GetRequiredServices(required);
    }

    void JointComponentBase::AddJointToGameEntity(
        AZ::Entity* gameEntity,
        const JointConfiguration& configuration) const
    {
        gameEntity->CreateComponent<Box3D::JointComponent>(configuration, m_parentEntity);
    }

    AZ::Transform JointComponentBase::GetLocalFrame(
        const JointFrame frame) const
    {
        const JointCommonConfiguration& configuration = GetCommonConfiguration();
        if (frame == JointFrame::Parent)
        {
            return configuration.m_parentLocalFrame;
        }

        return configuration.m_childLocalFrame;
    }

    void JointComponentBase::SetLocalFrame(
        const JointFrame frame,
        const AZ::Transform& localFrame)
    {
        ...
        if (frame == JointFrame::Parent)
        {
            configuration.m_parentLocalFrame = localFrame;
        }
        else
        {
            configuration.m_childLocalFrame = localFrame;
        }
        SetDirty();
        AzToolsFramework::ComponentModeFramework::ComponentModeSystemRequestBus::Broadcast(
    ...
    AZ::Transform JointComponentBase::GetFrameSpace(
        const JointFrame frame) const
    {
        AZ::Transform frameSpace = AZ::Transform::CreateIdentity();
    ...
    template<typename Component, class Configuration>
        ...
        const char* description)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            serializeContext->Class<Component, JointComponentBase>()->Field("Configuration", configuration);
    ...
    void ParallelJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
    ...
    void ParallelJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
    ...
    void DistanceJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void DistanceJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void FilterJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void FilterJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void MotorJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void MotorJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void PrismaticJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void PrismaticJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void RevoluteJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void RevoluteJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void SphericalJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void SphericalJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void WeldJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void WeldJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
    ...
    void WheelJointComponent::Reflect(
        AZ::ReflectContext* context)
    {
        ReflectJointComponent(
            context,
    ...
    void WheelJointComponent::BuildGameEntity(
        AZ::Entity* gameEntity)
    {
        AddJointToGameEntity(gameEntity, m_configuration);
    }
