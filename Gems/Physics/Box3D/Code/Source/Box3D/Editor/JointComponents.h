...
namespace Box3D::Editor
{
    ...
    public:
        [[nodiscard]]
        virtual AZ::Transform GetLocalFrame(JointFrame frame) const = 0;

        virtual void SetLocalFrame(
            JointFrame frame,
            const AZ::Transform& localFrame) = 0;

        [[nodiscard]]
        virtual AZ::Transform GetFrameSpace(JointFrame frame) const = 0;
    ...
    protected:
        void AddJointToGameEntity(
            AZ::Entity* gameEntity,
            const JointConfiguration& configuration) const;

        [[nodiscard]]
        virtual JointCommonConfiguration& GetCommonConfiguration() = 0;

        [[nodiscard]]
        virtual const JointCommonConfiguration& GetCommonConfiguration() const = 0;
    ...
    private:
        ...
        void SetLocalFrame(
            JointFrame frame,
            const AZ::Transform& localFrame) override;
    ...
    private:
        [[nodiscard]]
        JointCommonConfiguration& GetCommonConfiguration() override;

        [[nodiscard]]
        const JointCommonConfiguration& GetCommonConfiguration() const override;
