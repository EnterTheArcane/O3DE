...
namespace Box3D::Editor
{
    namespace
    {
        ...
        public:
            void DrawWireCapsule(
                ...
                float radius,
                float heightStraightSection) override
            {
                ++m_capsuleCount;
                m_center = center;
                m_axis = axis;
    ...
    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeCollider)
    {
    ...
    TEST(
        EditorComponentTests,
        ColliderDrawsAuthoredGeometryInTheViewport)
    {
        ColliderComponent editorComponent;
        ...
        EXPECT_TRUE(
            editorComponent.EditorSelectionIntersectRayViewport(
                {0},
    ...
    TEST_F(
        ComponentModeTests,
        ColliderManipulatorBusesEditTheActiveShape)
    {
    ...
    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeCharacterController)
    {
    ...
    TEST(
        EditorComponentTests,
        CharacterControllerDrawsAuthoredCapsuleInTheViewport)
    {
        CharacterControllerComponent editorComponent;
    ...
    TEST_F(
        ComponentModeTests,
        CharacterManipulatorBusesPreserveValidCapsuleDimensions)
    {
        AZ::Entity* editorEntity = nullptr;
    ...
    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeHeightfieldCollider)
    {
    ...
    TEST(
        EditorComponentTests,
        HeightfieldDrawsAuthoredGridInTheViewport)
    {
        HeightfieldColliderComponent editorComponent;
        UnitTest::TestDebugDisplayRequests debugDisplay;
        ...
        EXPECT_TRUE(selectionBounds.GetMax().IsClose(bounds.GetMax()));
        EXPECT_TRUE(
            editorComponent.EditorSelectionIntersectRayViewport({0}, AZ::Vector3(0.5f, 0.5f, 2.0f), -AZ::Vector3::CreateAxisZ(), distance));
        EXPECT_NEAR(distance, 2.0f, 1.0e-4f);
    }

    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeRigidBody)
    {
    ...
    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeStaticRigidBody)
    {
    ...
    TEST(
        EditorComponentTests,
        BuildGameEntityEmitsRuntimeEffects)
    {
    ...
    TEST(
        EditorComponentTests,
        EffectsDrawAuthoredInfluenceInTheViewport)
    {
        ExplosionComponent editorExplosion;
        WindComponent editorWind;
        ...
        EXPECT_TRUE(
            editorExplosion.EditorSelectionIntersectRayViewport(
                {0},
                AZ::Vector3::CreateAxisX(-2.0f),
                AZ::Vector3::CreateAxisX(),
                distance));
    ...
    TEST_F(
        ComponentModeTests,
        ExplosionManipulatorBusesEditLocalPositionAndRadius)
    {
        AZ::Entity* editorEntity = nullptr;
    ...
    TEST_F(
        ComponentModeTests,
        WindManipulatorBusEditsWorldSpaceVelocity)
    {
        AZ::Entity* editorEntity = nullptr;
    ...
    TEST_F(
        ComponentModeTests,
        JointManipulatorBusEditsBothLocalFrames)
    {
        AZ::Entity* editorEntity = nullptr;
    ...
    template<typename EditorComponent, class Configuration>
    ...
    TYPED_TEST(
        EditorJointComponentTests,
        BuildGameEntityPreservesConcreteJointKind)
    {
