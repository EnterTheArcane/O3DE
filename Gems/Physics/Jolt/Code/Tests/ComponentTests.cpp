...
namespace Jolt
{
    ...
    TEST(ComponentTests, BehaviorReflectionExposesEveryRuntimeComponentBus)
    {
        ...
        EXPECT_FALSE(behaviorContext.m_classes.contains("ShapePlacement"));
        ...
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShape"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeCastHit"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeCastRequest"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeCollisionHit"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeCollisionRequest"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeCollection"));
        EXPECT_FALSE(behaviorContext.m_classes.contains("TransformedShapeRaycastRequest"));
