...
namespace Jolt
{
        ...
        AZ::ReflectContext* context)
    {
        ...
        behaviorContext->Class<TransformedShapeRaycastRequest>("TransformedShapeRaycastRequest")
            ->Attribute(AZ::Script::Attributes::Scope, AZ::Script::Attributes::ScopeFlags::Common)
            ->Attribute(AZ::Script::Attributes::Module, "jolt")
            ->Constructor<>()
            ->Property("start", JOLT_BEHAVIOR_VALUE_PROPERTY(&TransformedShapeRaycastRequest::m_start))
            ->Property(
                "displacement",
                JOLT_BEHAVIOR_VALUE_PROPERTY(&TransformedShapeRaycastRequest::m_displacement))
            ->Property(
                "convexBackFaceMode",
                JOLT_BEHAVIOR_VALUE_PROPERTY(&TransformedShapeRaycastRequest::m_convexBackFaceMode))
            ->Property(
                "triangleBackFaceMode",
                JOLT_BEHAVIOR_VALUE_PROPERTY(&TransformedShapeRaycastRequest::m_triangleBackFaceMode))
            ->Property(
                "treatConvexAsSolid",
        ...
        behaviorContext->Class<TransformedShape>("TransformedShape")
            ->Attribute(AZ::Script::Attributes::Scope, AZ::Script::Attributes::ScopeFlags::Common)
            ->Attribute(AZ::Script::Attributes::Module, "jolt")
            ->Property("transform", &TransformedShape::GetTransform, nullptr)
            ->Property("bounds", &TransformedShape::GetBounds, nullptr)
            ->Property("scale", &TransformedShape::GetScale, nullptr)
