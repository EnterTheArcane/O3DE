...
namespace Jolt
{
    ...
    public:
        ...
        virtual void OnBodyDependencyDestroying(
            WorldHandle worldHandle,
            BodyHandle bodyHandle) = 0;
    };
    ...
    public:
        ...
        virtual void OnConstraintDependencyDestroying(
            WorldHandle worldHandle,
            ConstraintHandle constraintHandle) = 0;

        virtual void OnPathDependencyCreated(PathHandle pathHandle) = 0;

        virtual void OnPathDependencyDestroying(PathHandle pathHandle) = 0;
    };
    ...
    class ComponentDependencyManager final
    ...
    private:
        using BodyClientList = AZStd::vector<IBodyDependencyClient*>;
        using BodyClientMap = AZStd::unordered_map<AZ::EntityId, BodyClientList>;
        using ConstraintClientList = AZStd::vector<IConstraintDependencyClient*>;
        ...
        void OnPathDestroying(PathHandle pathHandle) override;
