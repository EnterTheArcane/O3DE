...
| `J3-AUD-024` | Contact publication meets the declared contention gate without weakening deterministic order or event completeness. | 6 | **Measured failure** — opt-in producer wait/hold/contention/growth telemetry and 30 fresh-process clang-cl Release rows prove the single mutex is not acceptable. At 128 bodies W8 is 1.181x W4; aggregate producer wait is 67.216% at W4 and 203.613% at W8. At 1,024 bodies it is 67.937% and 291.909%. Counts and effective workers match. Replace the producer topology with stable deterministic shards, then repeat the same evidence without weakening event semantics. |
