...
namespace LyShine
{
    ...
    public: // functions
        ...
        virtual void Render(
            UiRenderer* uiRenderer, const AZ::Matrix4x4& modelViewProjMat, AZ::RHI::Ptr<AZ::RPI::DynamicDrawContext> dynamicDraw) = 0;
    ...
    class LyShinePoolAllocator final : public AZ::PoolAllocator
    {
    public:
    ...
    public: // functions
        ...
        void Render(
            UiRenderer* uiRenderer, const AZ::Matrix4x4& modelViewProjMat, AZ::RHI::Ptr<AZ::RPI::DynamicDrawContext> dynamicDraw) override;
        ...
        {
            return m_textures[texIndex].m_texture;
        }
        bool GetTextureIsClampMode(int texIndex) const
        {
            return m_textures[texIndex].m_isClampTextureMode;
        }

        bool GetIsTextureSRGB() const
        {
            return m_isTextureSRGB;
        }
        AZ::RHI::TargetBlendState GetBlendModeState() const
        {
            return m_blendModeState;
        }
    ...
    private: // functions
        void SetupBeforeRenderingMask(
            UiRenderer* uiRenderer,
            AZ::RHI::Ptr<AZ::RPI::DynamicDrawContext> dynamicDraw,
            bool firstPass,
            UiRenderer::BaseState priorBaseState);
        void SetupAfterRenderingMask(
            UiRenderer* uiRenderer,
            AZ::RHI::Ptr<AZ::RPI::DynamicDrawContext> dynamicDraw,
            bool firstPass,
            UiRenderer::BaseState priorBaseState);
    ...
    public:
        ...
        LyShine::UiPrimitive* GetDynamicQuadPrimitive(const AZ::Vector2* positions, AZ::u32 packedColor) override;
        ...
        void DebugReportDrawCallsRenderNodeList(
            const AZStd::vector<RenderNode*>& renderNodeList,
