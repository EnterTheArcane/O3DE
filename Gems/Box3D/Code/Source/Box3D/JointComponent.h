...
namespace Box3D
{
    ...
    public:
        ...
        JointComponent(JointConfiguration configuration, AZ::EntityId parentEntityId = AZ::EntityId());
        ...
        [[nodiscard]] JointHandle GetJointHandle() const override;
        [[nodiscard]] JointConfiguration GetConfiguration() const override;
        bool UpdateConfiguration(const JointConfiguration& configuration) override;
        [[nodiscard]] JointMeasurements GetMeasurements() const override;
        bool WakeBodies() override;
        [[nodiscard]] ParallelJointConfiguration GetParallelConfiguration() const override;
        bool UpdateParallelConfiguration(const ParallelJointConfiguration& configuration) override;
        [[nodiscard]] DistanceJointConfiguration GetDistanceConfiguration() const override;
        bool UpdateDistanceConfiguration(const DistanceJointConfiguration& configuration) override;
        [[nodiscard]] FilterJointConfiguration GetFilterConfiguration() const override;
        bool UpdateFilterConfiguration(const FilterJointConfiguration& configuration) override;
        [[nodiscard]] MotorJointConfiguration GetMotorConfiguration() const override;
        bool UpdateMotorConfiguration(const MotorJointConfiguration& configuration) override;
        [[nodiscard]] PrismaticJointConfiguration GetPrismaticConfiguration() const override;
        bool UpdatePrismaticConfiguration(const PrismaticJointConfiguration& configuration) override;
        [[nodiscard]] RevoluteJointConfiguration GetRevoluteConfiguration() const override;
        bool UpdateRevoluteConfiguration(const RevoluteJointConfiguration& configuration) override;
        [[nodiscard]] SphericalJointConfiguration GetSphericalConfiguration() const override;
        bool UpdateSphericalConfiguration(const SphericalJointConfiguration& configuration) override;
        [[nodiscard]] WeldJointConfiguration GetWeldConfiguration() const override;
        bool UpdateWeldConfiguration(const WeldJointConfiguration& configuration) override;
        [[nodiscard]] WheelJointConfiguration GetWheelConfiguration() const override;
        bool UpdateWheelConfiguration(const WheelJointConfiguration& configuration) override;
        [[nodiscard]] DistanceJointState GetDistanceState() const override;
        [[nodiscard]] PrismaticJointState GetPrismaticState() const override;
        [[nodiscard]] RevoluteJointState GetRevoluteState() const override;
        [[nodiscard]] SphericalJointState GetSphericalState() const override;
        [[nodiscard]] WheelJointState GetWheelState() const override;
