...
namespace Box3D
{
    ...
    public:
        ...
        explicit ExplosionComponent(ExplosionConfiguration configuration, AZ::Name worldName = {}, bool explodeOnActivate = false);
        ...
        [[nodiscard]] bool Explode() override;
        [[nodiscard]] ExplosionConfiguration GetConfiguration() const override;
    ...
    public:
        ...
        explicit WindComponent(WindConfiguration configuration, bool enabled = true);
        ...
        [[nodiscard]] WindConfiguration GetConfiguration() const override;
