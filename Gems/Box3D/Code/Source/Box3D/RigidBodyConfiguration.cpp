...
namespace Box3D
{
    void RigidBodyConfiguration::Reflect(AZ::ReflectContext* context)
    {
        if (auto* serializeContext = azrtti_cast<AZ::SerializeContext*>(context))
        {
            ...
            serializeContext->Class<MotionLocks>()
                ->Version(0)
            ...
            serializeContext->Class<RigidBodyConfiguration>()
                ->Version(1)
            ...
            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                ...
                editContext->Class<RigidBodyConfiguration>("Rigid body", "Initial state and simulation policy")
                    ...
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default, &RigidBodyConfiguration::m_enableContactRecycling, "Contact recycling", "");
            }
        }
    }
} // namespace Box3D
