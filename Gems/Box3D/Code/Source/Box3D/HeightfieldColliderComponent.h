...
namespace Box3D
{
    ...
    public:
        ...
        explicit HeightfieldColliderComponent(ShapeConfiguration configuration, AZ::Name worldName = {});
        ...
        [[nodiscard]] ShapeHandle GetShapeHandle() const override;
        [[nodiscard]] AZ::u32 GetColumnCount() const override;
        [[nodiscard]] AZ::u32 GetRowCount() const override;
        [[nodiscard]] AZStd::span<const float> GetHeights() const override;
        [[nodiscard]] AZStd::span<const AZ::u8> GetMaterialIndices() const override;
        bool ReplaceHeightfield(const HeightfieldShapeConfiguration& configuration) override;
        bool UpdateHeights(
            AZ::u32 startColumn, AZ::u32 startRow, AZ::u32 columnCount, AZ::u32 rowCount, AZStd::span<const float> heights) override;
