...
namespace Box3D
{
    void CharacterConfiguration::Reflect(AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext->Class<CollisionFilter>()
                ->Version(1)
            ...
            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                ...
                editContext->Class<CharacterConfiguration>("Character", "Capsule mover geometry and movement limits")
                    ...
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default, &CharacterConfiguration::m_minimumMovementDistance, "Minimum movement distance", "")
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ->DataElement(AZ::Edit::UIHandlers::Default, &CharacterConfiguration::m_maximumSpeed, "Maximum speed", "")
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default, &CharacterConfiguration::m_groundStickDistance, "Ground stick distance", "")
                    ->Attribute(AZ::Edit::Attributes::Min, 0.0f)
                    ...
                    ->DataElement(
                        AZ::Edit::UIHandlers::Default, &CharacterConfiguration::m_maximumContactPlanes, "Contact plane capacity", "")
                    ->Attribute(AZ::Edit::Attributes::Min, 1)
