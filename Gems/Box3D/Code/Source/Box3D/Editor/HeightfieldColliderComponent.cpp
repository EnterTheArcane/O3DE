...
namespace Box3D::Editor
{
    void HeightfieldColliderComponent::Reflect(AZ::ReflectContext* context)
    {
        ...
        {
            serializeContext->Class<HeightfieldColliderComponent, AzToolsFramework::Components::EditorComponentBase>()
                ->Version(1)
            ...
            if (AZ::EditContext* editContext = serializeContext->GetEditContext())
            {
                editContext
                    ->Class<HeightfieldColliderComponent>(
                        QT_TRANSLATE_NOOP("Box3D", "Box3D Heightfield Collider"),
                        QT_TRANSLATE_NOOP("Box3D", "Creates mutable static terrain collision from height samples."))
                    ...
                    ->DataElement(
                        ...
                        &HeightfieldColliderComponent::m_worldName,
                    ...
                    ->DataElement(
                        ...
                        QT_TRANSLATE_NOOP("Box3D", "Heightfield"),
                        QT_TRANSLATE_NOOP("Box3D", "Samples, materials, filtering, and event policy."))
    ...
    void HeightfieldColliderComponent::BuildGameEntity(AZ::Entity* gameEntity)
    {
