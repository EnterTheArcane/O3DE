...
namespace Box3D
{
    ...
    void JointComponent::GetProvidedServices(AZ::ComponentDescriptor::DependencyArrayType& provided)
    {
        provided.push_back(AZ_CRC_CE("Box3DJointService"));
    }

    void JointComponent::GetIncompatibleServices(AZ::ComponentDescriptor::DependencyArrayType& incompatible)
    {
        incompatible.push_back(AZ_CRC_CE("Box3DJointService"));
    }

    void JointComponent::GetRequiredServices(AZ::ComponentDescriptor::DependencyArrayType& required)
    {
    ...
    {
        return m_system != nullptr && m_jointHandle.IsValid();
    }
    ...
    bool JointComponent::UpdateConfiguration(const JointConfiguration& configuration)
    {
        if (m_system != nullptr && m_jointHandle.IsValid())
        {
            JointConfiguration resolved;
            WorldHandle worldHandle;
            if (!ResolveConfiguration(configuration, resolved, worldHandle) || worldHandle != m_worldHandle ||
    ...
    {
        return m_system != nullptr && m_system->WakeJointBodies(m_worldHandle, m_jointHandle);
    }
    ...
    bool JointComponent::UpdateParallelConfiguration(const ParallelJointConfiguration& configuration)
    {
    ...
    bool JointComponent::UpdateDistanceConfiguration(const DistanceJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateFilterConfiguration(const FilterJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateMotorConfiguration(const MotorJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdatePrismaticConfiguration(const PrismaticJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateRevoluteConfiguration(const RevoluteJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateSphericalConfiguration(const SphericalJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateWeldConfiguration(const WeldJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    bool JointComponent::UpdateWheelConfiguration(const WheelJointConfiguration& configuration)
    {
        return UpdateConfiguration(configuration);
    }
    ...
    void JointComponent::OnBodyCreated(WorldHandle, BodyHandle)
    {
        DisableSimulation();
        EnableSimulation();
    }
