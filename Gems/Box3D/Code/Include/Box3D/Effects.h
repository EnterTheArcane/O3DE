...
namespace Box3D
{
    ...
    public:
        ...
        [[nodiscard]] virtual bool Explode(WorldHandle worldHandle, const ExplosionConfiguration& configuration) = 0;
        [[nodiscard]] virtual bool ApplyWind(WorldHandle worldHandle, BodyHandle bodyHandle, const WindConfiguration& configuration) = 0;
    };
} // namespace Box3D
