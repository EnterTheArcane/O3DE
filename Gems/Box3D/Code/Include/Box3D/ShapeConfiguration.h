...
namespace Box3D
{
    ...
    struct CompoundChildShapeConfiguration final
    {
        ...
        [[nodiscard]] CompoundChildType GetType() const;
        [[nodiscard]] SphereShapeConfiguration GetSphere() const;
        [[nodiscard]] CapsuleShapeConfiguration GetCapsule() const;
        [[nodiscard]] BoxShapeConfiguration GetBox() const;
        [[nodiscard]] CylinderShapeConfiguration GetCylinder() const;
        [[nodiscard]] ConvexHullShapeConfiguration GetConvexHull() const;
        [[nodiscard]] TriangleMeshShapeConfiguration GetTriangleMesh() const;
    ...
    struct ShapeProperties final
    {
        ...
        void SetMaterials(const MaterialHandleCollection& materials)
        {
            const AZStd::span<const MaterialHandle> handles = materials.GetHandles();
            m_materials.assign(handles.begin(), handles.end());
        }
        [[nodiscard]] MaterialHandleCollection GetMaterials() const
        {
