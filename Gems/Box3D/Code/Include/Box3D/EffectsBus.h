...
namespace Box3D
{
    ...
    public:
        ...
        [[nodiscard]] virtual bool Explode() = 0;
        [[nodiscard]] virtual ExplosionConfiguration GetConfiguration() const = 0;
    ...
    public:
        ...
        [[nodiscard]] virtual WindConfiguration GetConfiguration() const = 0;
