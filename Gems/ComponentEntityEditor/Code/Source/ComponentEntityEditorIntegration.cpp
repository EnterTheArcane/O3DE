...
namespace ComponentEntityEditorInternal
{
...
ComponentEntityEditorIntegration::ComponentEntityEditorIntegration()
{
    m_appListener = AZStd::make_unique<SandboxIntegrationManager>();
    m_appListener->Setup();
    ...
    ComponentEntityEditorInternal::RegisterSandboxObjects();

    // Check for common mistakes in component declarations
    ComponentEntityEditorInternal::CheckComponentDeclarations();
...
ComponentEntityEditorIntegration::~ComponentEntityEditorIntegration()
{
    if (m_registered)
    {
        ...
        ComponentEntityEditorInternal::UnregisterSandboxObjects();
    }
