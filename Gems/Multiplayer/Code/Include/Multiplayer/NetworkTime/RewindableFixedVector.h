...
namespace Multiplayer
{
    ...
    public:
        ...
        const_iterator begin() const { return m_container.data(); }
        const_iterator end() const { return m_container.data() + aznumeric_cast<size_t>(size()); }
        typedef RewindableObject<TYPE, Multiplayer::RewindHistorySize>* iterator;
        constexpr iterator begin() { return m_container.data(); }
        constexpr iterator end() { return m_container.data() + aznumeric_cast<size_t>(size()); }
