...
namespace UnitTest
{
    ...
    */
    ...
    static constexpr AZStd::array<uint32_t, 36> CubeIndices = {
    ...
    static constexpr AZStd::array<uint32_t, 6> QuadIndices = { 0, 2, 1, 1, 2, 3 };
    ...
    */
    ...
    // clang-format off
    static constexpr AZStd::array<uint32_t, 108> TwoSeparatedPlanesIndices{
