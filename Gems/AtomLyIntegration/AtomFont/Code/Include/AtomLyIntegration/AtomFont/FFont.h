...
namespace AZ
{
    ...
    private:
        ...
        AZ::Vector2 GetTextSizeUInternal(const RHI::Viewport& viewport, const char* str, const bool asciiMultiLine, const TextDrawContext& ctx);
        AZ::Vector2 GetKerningInternal(const RHI::Viewport& viewport, uint32_t leftGlyph, uint32_t rightGlyph, const TextDrawContext& ctx) const;
        ...
        using AddFunction = AZStd::function<bool(const AZ::Vector3&, const AZ::Vector3&, const AZ::Vector3&, const AZ::Vector3&, const AZ::Vector2&, const AZ::Vector2&, const AZ::Vector2&, const AZ::Vector2&, uint32_t)>;
