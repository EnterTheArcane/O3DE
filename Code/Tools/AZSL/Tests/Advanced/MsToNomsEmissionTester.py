...
def do_tests(compiler, silent):
    ...
    # remain unchanged.
    azsl_file = os.path.abspath(os.path.join(work_dir, "./Texture2dmsToTexture2d.azsl"))

    fail_list = []
    pattern_file = os.path.abspath(os.path.join(work_dir, "./Texture2dmsToTexture2d.txt"))
    ...
    pattern_file = os.path.abspath(os.path.join(work_dir, "./Texture2dmsToTexture2dNoms.txt"))
