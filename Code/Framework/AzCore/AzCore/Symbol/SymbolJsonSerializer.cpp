...
namespace AZ
{
        ...
        JsonDeserializerContext& context)
    {
        ...
        const AZStd::string_view spelling{inputValue.GetString(), inputValue.GetStringLength()};
        const Internal::SymbolValidationError error = Internal::ValidateSymbolSpelling(spelling);
