...
namespace AZStd::ranges
{
    ...
    public:
        constexpr repeat_view() requires default_initializable<W> {}

        constexpr explicit repeat_view(const W& value, Bound bound = {}) requires copy_constructible<W>
            : m_value(value)
            , m_bound(bound)
        {
        }
...
namespace AZStd::ranges
{
    ...
    public:
        ...
        constexpr iterator() requires default_initializable<W> {}
