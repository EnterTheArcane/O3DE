...
namespace AZStd::ranges
{
    ...
    namespace ZipViewInternal
    {
        ...
        constexpr bool all_random_access = (random_access_range<::AZStd::ranges::Internal::maybe_const<Const, Views>>&&...);
        template<bool Const, class... Views>
        constexpr bool all_bidirectional = (bidirectional_range<::AZStd::ranges::Internal::maybe_const<Const, Views>>&&...);
        template<bool Const, class... Views>
        constexpr bool all_forward = (forward_range<::AZStd::ranges::Internal::maybe_const<Const, Views>>&&...);
