...
namespace AZStd
{
    ...
    constexpr auto expected<T, E>::operator=(const unexpected<G>& err) -> expected&
    {
        if (!has_value())
        {
    ...
    template<class G>
        requires is_constructible_v<E, G>
            && is_assignable_v<E&, G>
    constexpr auto expected<T, E>::operator=(unexpected<G>&& err) -> expected&
    {
        if (!has_value())
        {
            // direct intialize from error
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::operator*() const & noexcept -> add_lvalue_reference_t<const T>
        requires (!is_void_v<T>)
    {
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::operator*() & noexcept -> add_lvalue_reference_t<T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return this->m_storage.m_value;
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::operator*() const && noexcept -> add_rvalue_reference_t<const T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::operator*() && noexcept -> add_rvalue_reference_t<T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return AZStd::move(this->m_storage.m_value);
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::value() const & -> add_lvalue_reference_t<const T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return this->m_storage.m_value;
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::value() & -> add_lvalue_reference_t<T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return this->m_storage.m_value;
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::value() const && -> add_rvalue_reference_t<const T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return AZStd::move(this->m_storage.m_value);
    ...
    template<class T, class E>
    constexpr auto expected<T, E>::value() && -> add_rvalue_reference_t<T>
        requires (!is_void_v<T>)
    {
        AZ_Assert(has_value(), "expected doesn't have a value, uninitalized data will be returned");
        return AZStd::move(this->m_storage.m_value);
    ...
    template<class U>
        requires (!is_void_v<T>)
    constexpr auto expected<T, E>::value_or(U&& value) const & -> T
    {
    ...
    template<class U>
        requires (!is_void_v<T>)
    constexpr auto expected<T, E>::value_or(U&& value) && -> T
    {
