...
namespace AZStd
{
    ...
    public:
        ...
        [[nodiscard]] pointer allocate(size_type byteSize, size_type alignment, [[maybe_unused]] int flags = 0)
        {
    ...
    private:
        aligned_storage<Size, Alignment>::type m_data;
        char* m_freeData;
    ...
    public:
        ...
        AZ_FORCE_INLINE static_pool_allocator(const static_pool_allocator&)
            { reset(); }
        AZ_FORCE_INLINE static_pool_allocator& operator=(const static_pool_allocator&) { return *this; }

        constexpr size_type max_size() { return NumNodes * sizeof(Node); }
        AZ_FORCE_INLINE size_type get_allocated_size() const { return m_numOfAllocatedNodes * sizeof(Node); }

        [[nodiscard]] inline Node* allocate()
        {
        ...
        [[nodiscard]] inline pointer allocate(size_type byteSize, size_type alignment, int flags = 0)
        {
        ...
        AZ_FORCE_INLINE constexpr size_type data_size() { return sizeof(Node) * NumNodes; }
