...
namespace AzNetworking
{
    ...
    void UdpReaderThread::SwapBuffers()
    {
        ...
        AZStd::scoped_lock<AZStd::recursive_mutex> lock(m_mutex);
        {
            ...
            m_pendingAdds.clear();
            AZStd::erase_if(front.m_entries.begin(), front.m_entries.end(), [](auto& socketEntry) { return socketEntry.m_socket == nullptr; });
            AZStd::erase_if(back.m_entries.begin(), back.m_entries.end(), [](auto& socketEntry) { return socketEntry.m_socket == nullptr; });
