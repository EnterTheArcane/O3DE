...
namespace AZ::ShaderCompiler
{
    enum AzslcErrorCode : uint16_t
    {
        ...
        ORCHESTRATOR_DEPORTED_METHOD_DEFINITION = 2u, ORCHESTRATOR_DEFINITION_FOREIGN_SCOPE = 3u, ORCHESTRATOR_NO_DECLERATION = 4u, ORCHESTRATOR_UNEXPECTED_KIND = 5u, ORCHESTRATOR_OVERLY_QUALIFIED = 6u, ORCHESTRATOR_DEPORTED_METHOD = 7u, ORCHESTRATOR_FUNCTION_ALREADY_DEFINED = 8u, ORCHESTRATOR_INVALID_INLINED_QUALIFIER = 9u, ORCHESTRATOR_INVALID_NONGLOBAL_OPTION_OR_ROOTCONSTANT = 11u, ORCHESTRATOR_ILLEGAL_GLOBAL_VARIABLE = 12u, ORCHESTRATOR_ILLEGAL_MEMBER_VARIABLE_IN_INTERFACE = 13u, ORCHESTRATOR_ILLEGAL_FOLDABLE_ARRAY_DIMENSIONS = 14u, ORCHESTRATOR_INVALID_QUALIFIER_MIX = 15u, ORCHESTRATOR_UNSPECIFIED_BASE_SYMBOL = 16u, ORCHESTRATOR_INVALID_INTERFACE = 17u, ORCHESTRATOR_CLASS_REDEFINE = 18u, ORCHESTRATOR_UNREGISTERED_METHOD = 19u, ORCHESTRATOR_HIDING_SYMBOL_BASE = 20u, ORCHESTRATOR_INVALID_OVERRIDE_SPECIFIER_CLASS = 21u, ORCHESTRATOR_INVALID_OVERRIDE_SPECIFIER_BASE = 22u, ORCHESTRATOR_INVALID_SEMANTIC_DECLARATION = 23u, ORCHESTRATOR_INVALID_SEMANTIC_DECLARATION_TYPE = 24u, ORCHESTRATOR_INVALID_EXTERNAL_BOUND_RESOURCE_VIEW = 25u, ORCHESTRATOR_INVALID_GENERIC_TYPE_CONSTANTBUFFER = 26u, ORCHESTRATOR_UNDECLARED_GENERIC_TYPE_CONSTANTBUFFER = 27u, ORCHESTRATOR_INVALID_GENERIC_TYPE_CONSTANTBUFFER_STRUCT = 28u, ORCHESTRATOR_LITERAL_REQUIRED_SRG_SEMANTIC = 29u, ORCHESTRATOR_INVALID_INTEGER_CONSTANT = 30u, ORCHESTRATOR_INVALID_RANGE_FREQUENCY_ID = 31u, ORCHESTRATOR_ODR_VIOLATION = 32u, // One Definition Rule
        ORCHESTRATOR_DISALLOWED_FUNCTION_MODIFIER = 33u, ORCHESTRATOR_MULTIPLE_HIDDEN_SYMBOLS = 34u, ORCHESTRATOR_SCOPE_NOT_FOUND = 35u, ORCHESTRATOR_INVALID_TYPEALIAS_TARGET = 36u, ORCHESTRATOR_NO_DOUBLE_DEFAULT_DECLARATION = 37u, ORCHESTRATOR_NO_DEFAULT_PARAM_WITH_OVERLOADS = 38u, ORCHESTRATOR_FUNCTION_INCONSISTENT_RETURN_TYPE = 39u, ORCHESTRATOR_NO_INLINE_UDT_IN_PARAMETERS = 40u, ORCHESTRATOR_OVERLOAD_RESOLUTION_HARD_FAILURE = 41u, ORCHESTRATOR_EXTERNAL_VARIABLE_WITH_INITIALIZER = 42u, ORCHESTRATOR_MEMBER_VARIABLE_WITH_INITIALIZER = 43u, ORCHESTRATOR_SRG_REUSES_A_FREQUENCY = 44u, ORCHESTRATOR_NON_PACKABLE_TYPE_IN_SRG_CONSTANT = 45u, ORCHESTRATOR_TRYING_TO_EXTEND_NOT_PARTIAL_SRG = 46u, ORCHESTRATOR_SRG_EXTENSION_HAS_DIFFERENT_SEMANTIC = 47u, ORCHESTRATOR_UNBOUNDED_RESOURCE_ISSUE = 48u, ORCHESTRATOR_UNKNOWN_OPTION_TYPE = 49u, ORCHESTRATOR_CONSTANT_FOLDING_FAULT = 50u, ORCHESTRATOR_TYPE_LOOKUP_FAULT = 51u,

        // Treat all compiler warnings as errors
        WX_WARNINGS_AS_ERRORS = 127u,

        // intermediate representation error codes
        IR_MULTIPLE_SRG_FALLBACK = 128u, IR_NO_FALLBACK_ASSIGNED = 129u, IR_SRG_WITHOUT_SEMANTIC = 130u, IR_POTENTIAL_DX12_VS_VULKAN_ALIGNMENT_ERROR = 131u, IR_INVALID_PAD_TO_ARGUMENTS = 132u, IR_INVALID_PAD_TO_LOCATION = 133u, IR_PAD_TO_CASE_REQUIRES_POWER_OF_TWO = 134u,

        // emitter error codes
        EMITTER_INVALID_ARRAY_DIMENSIONS = 256u, EMITTER_RECURSION_NOT_PERMITTED = 257u, EMITTER_OVERFLOW_BIT_BOUNDARY = 258u, EMITTER_OPTION_EXCEEDING_BITS_COUNT = 259u, EMITTER_INTEGER_RANGE_NEEDS_ATTRIBUTE = 260u, EMITTER_INTEGER_RANGE_MIN_IS_NOT_CONST = 261u, EMITTER_INTEGER_RANGE_MAX_IS_NOT_CONST = 262u, EMITTER_INTEGER_RANGE_MIN_IS_BIGGER_THAN_MAX = 263u, EMITTER_INTEGER_HAS_NO_RANGE = 264u, EMITTER_OPTION_HAS_UNSUPPORTED_TYPE = 265u, EMITTER_UNEXPECTED_EXPRESSION = 266u, EMITTER_UNDEFINED_SRG_MEMBER = 267u,

        // others
        ADVANCED_SYNTAX_DOUBLE_SCOPE_RESOLUTION = 514u, ADVANCED_RESERVED_NAME_USED = 515u, ADVANCED_SYNTAX_FUNCTION_IN_STRUCT = 516u,
    };
