...
class Recipe(RecipeBase[_Options]):
    ...
    def source(self):
        get(
            self,
            url=f"https://www.x.org/releases/individual/lib/libXt-{self.version}.tar.xz",
    ...
    def package_info(self):
        self.info.set_property("pkg_config_name", "xt")
        self.info.libs = ["Xt"]
        self.info.requires = [
            "libsm::libsm", "libice::libice", "libx11::x11", "xorg-proto::kbproto",
        ]
