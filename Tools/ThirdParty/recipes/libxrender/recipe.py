...
class Recipe(RecipeBase[_Options]):
    ...
    def source(self):
        get(
            self,
            url=f"https://www.x.org/releases/individual/lib/libXrender-{self.version}.tar.xz",
    ...
    def package_info(self):
        self.info.set_property("pkg_config_name", "xrender")
        self.info.libs = ["Xrender"]
        self.info.requires = ["libx11::x11", "xorg-proto::renderproto"]
