...
class Recipe(RecipeBase):
    ...
    def latest_version(self):
        return Version(GnuFtp(self, "mpfr").latest_release)
    ...
    def source(self):
        get(
            self,
            url=[
                f"https://ftpmirror.gnu.org/gnu/mpfr/mpfr-{self.version}.tar.xz",
                f"https://ftp.gnu.org/gnu/mpfr/mpfr-{self.version}.tar.xz",
            ],
