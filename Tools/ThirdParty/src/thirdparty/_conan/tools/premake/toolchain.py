...
from thirdparty._conan.tools.env.virtualbuildenv import VirtualBuildEnv
...
from thirdparty._conan.tools.microsoft.visual import VCVars
from thirdparty._conan.tools.premake.premakedeps import PREMAKE_ROOT_FILE
...
def _generate_flags(self, conanfile):
    template = textwrap.dedent(
        ...
        {% endif %}
        {% if extra_rcflags %}
        -- RC flags retrieved from thirdparty._conan.conf(tools.build:rcflags)
        filter { files { "**.rc" } }
