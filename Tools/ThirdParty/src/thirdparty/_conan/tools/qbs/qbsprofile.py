...
from thirdparty._conan.tools.microsoft import msvs_toolset
from thirdparty._conan.tools.microsoft.visual import vs_installation_path, _vcvars_path, _vcvars_versions
from thirdparty._conan.tools.qbs import common
