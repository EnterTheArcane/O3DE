...
from thirdparty._conan.tools.apple.apple import to_apple_arch, xcodebuild_deployment_target_key
from thirdparty._conan.tools.apple.xcodedeps import GLOBAL_XCCONFIG_FILENAME, GLOBAL_XCCONFIG_TEMPLATE, \
