...
from thirdparty._conan.internal.api.detect.detect_vs import vs_installation_path
from thirdparty._conan.errors import ConanException, ConanInvalidConfiguration
from thirdparty._conan.tools.scm import Version
from thirdparty._conan.tools.intel.intel_cc import IntelCC
...
class VCVars:
    ...
    def generate(self, scope="build"):
        ...
        content = textwrap.dedent(f"""\
            ...
            {vcvars}
            """)
        from thirdparty._conan.tools.env.environment import create_env_script
