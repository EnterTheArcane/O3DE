...
from thirdparty._conan.errors import ConanInvalidConfiguration, ConanException
from thirdparty._conan.internal.api.detect.detect_api import default_cppstd as default_cppstd_
