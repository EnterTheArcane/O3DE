...
from thirdparty._conan.internal.rest.caching_file_downloader import SourcesCachingDownloader
from thirdparty._conan.errors import ConanException
from thirdparty._conan.internal.rest.file_uploader import FileProgress
from thirdparty._conan.internal.util.files import rmdir as _internal_rmdir, human_size, check_with_algorithm_sum
...
def chmod(conanfile, path: str, read: Optional[bool] = None, write: Optional[bool] = None,
    ...
    .. code-block:: python
        ...
        from thirdparty._conan.tools.files import chmod
