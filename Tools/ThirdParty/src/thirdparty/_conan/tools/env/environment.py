...
from thirdparty._conan.internal.subsystems import deduce_subsystem, WINDOWS, subsystem_path
    ...
    for group, env_scripts in conanfile.env_scripts.items():
        ...
        if bats:
            ...
            def bat_content(files):
                ...
                if deactivation_mode == "function":
                    from thirdparty._conan.tools.microsoft.visual import CONAN_VCVARS
