...
from thirdparty._conan.api.output import Color
from thirdparty._conan.internal import check_duplicated_generator
from thirdparty._conan.tools.cmake.cmakedeps import FIND_MODE_CONFIG, FIND_MODE_NONE, FIND_MODE_BOTH, \
    FIND_MODE_MODULE
from thirdparty._conan.tools.cmake.cmakedeps.templates.config import ConfigTemplate
from thirdparty._conan.tools.cmake.cmakedeps.templates.config_version import ConfigVersionTemplate
from thirdparty._conan.tools.cmake.cmakedeps.templates.macros import MacrosTemplate
from thirdparty._conan.tools.cmake.cmakedeps.templates.target_configuration import TargetConfigurationTemplate
from thirdparty._conan.tools.cmake.cmakedeps.templates.target_data import ConfigDataTemplate
from thirdparty._conan.tools.cmake.cmakedeps.templates.targets import TargetsTemplate
from thirdparty._conan.tools.files import save
from thirdparty._conan.errors import ConanException
from thirdparty._conan.internal.model.dependencies import get_transitive_requires
