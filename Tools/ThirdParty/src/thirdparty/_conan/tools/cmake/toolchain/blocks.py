...
from thirdparty._conan.internal.internal_tools import universal_arch_separator, is_universal_arch
from thirdparty._conan.tools.apple.apple import get_apple_sdk_fullname, _to_apple_arch
from thirdparty._conan.tools.android.utils import android_abi
from thirdparty._conan.tools.apple.apple import is_apple_os, to_apple_arch
from thirdparty._conan.tools.build import build_jobs
from thirdparty._conan.tools.build.flags import architecture_flag, architecture_link_flag, libcxx_flags, threads_flags
from thirdparty._conan.tools.build.cross_building import cross_building
from thirdparty._conan.tools.cmake.toolchain import CONAN_TOOLCHAIN_FILENAME
from thirdparty._conan.tools.cmake.utils import is_multi_configuration
from thirdparty._conan.tools.intel import IntelCC
from thirdparty._conan.tools.microsoft.visual import msvc_version_to_toolset_version, msvc_platform_from_arch
from thirdparty._conan.internal.api.install.generators import relativize_path
from thirdparty._conan.internal.subsystems import deduce_subsystem, WINDOWS
from thirdparty._conan.errors import ConanException
from thirdparty._conan.internal.model.version import Version
from thirdparty._conan.internal.util.files import load
...
class ExtraVariablesBlock(Block):
    ...
    def context(self):
        from thirdparty._conan.tools.cmake.utils import parse_extra_variable
