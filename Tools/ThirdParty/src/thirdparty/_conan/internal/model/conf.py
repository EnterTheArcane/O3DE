...
from thirdparty._conan.internal.api.detect import detect_api
from thirdparty._conan.internal.cache.home_paths import HomePaths
from thirdparty._conan.internal.model.options import _PackageOption
from thirdparty._conan.internal.model.recipe_ref import ref_matches
from thirdparty._conan.internal.model.settings import SettingsItem
from thirdparty._conan.internal.util.files import load, save
...
def load_global_conf(home_folder):
    ...
    if os.path.exists(global_conf_path):
        ...
        from thirdparty._conan import conan_version
