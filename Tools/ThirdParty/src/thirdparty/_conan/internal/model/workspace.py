...
from thirdparty._conan.internal.errors import scoped_traceback
...
class Workspace:
    ...
    def load_conanfile(self, conanfile_path):
        ...
        from thirdparty._conan.internal.loader import ConanFileLoader
        from thirdparty._conan.internal.cache.home_paths import HomePaths
        from thirdparty._conan.internal.conan_app import ConanFileHelpers, CmdWrapper
