...
class CMake:
    ...
    def configure(
        self, variables=None, build_script_folder=None, cli_args=None, stdout=None, stderr=None, subfolder=None):
        """
    ...
    def _build(
        self, build_type=None, target=None, cli_args=None, build_tool_args=None, env="", stdout=None, stderr=None, subfolder=None):
    ...
    def build(
        self, build_type=None, target=None, cli_args=None, build_tool_args=None, stdout=None, stderr=None, subfolder=None):
        """
    ...
    def install(
        self, build_type=None, component=None, cli_args=None, stdout=None, stderr=None, subfolder=None):
        """
        ...
        deprecated_install_strip = self._recipe.conf.get(
            "tools.cmake:install_strip", check_type=bool)
        if deprecated_install_strip:
            self._recipe.output.warning(
                "The 'tools.cmake:install_strip' configuration is "
                "deprecated, use 'tools.build:install_strip' instead.", warn_tag="deprecated")
    ...
    def test(
        self, build_type=None, target=None, cli_args=None, build_tool_args=None, env="", stdout=None, stderr=None):
        """
