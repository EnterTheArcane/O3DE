...
class CMake:
    ...
    def configure(self, variables=None, build_script_folder=None, cli_args=None,
        ...
        extra_args = self._recipe.conf.get("tools.cmake:configure_args", check_type=list,
                                              default=[])
    ...
    def _config_arg(self, build_type):
        ...
        if build_type and not is_multi:
            self._recipe.output.error("Don't specify 'build_type' at build time for "
    ...
    def install(self, build_type=None, component=None, cli_args=None, stdout=None, stderr=None,
        ...
        deprecated_install_strip = self._recipe.conf.get("tools.cmake:install_strip",
                                                            check_type=bool)
        if deprecated_install_strip:
            self._recipe.output.warning("The 'tools.cmake:install_strip' configuration is "
