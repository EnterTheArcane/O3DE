...
class CMake:
    ...
    def configure(
        self, variables: dict[str, Any] | None = None, build_script_folder: str | None = None, cli_args: list[str] | None = None, stdout: IO[Any] | None = None, stderr: IO[Any] | None = None, subfolder: str | None = None):
        """
