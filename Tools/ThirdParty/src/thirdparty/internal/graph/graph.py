...
from thirdparty.internal.graph.graph_error import GraphError, GraphConflictError
...
class Node:
    ...
    def serialize(self):
        ...
        from thirdparty.internal.graph.installer import build_id
...
class DepsGraph:
    ...
    def lockfile(self):
        from thirdparty.internal.model.lockfile import Lockfile
