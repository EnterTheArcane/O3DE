...
from thirdparty.internal.methods import auto_header_only_package_id
from thirdparty.internal.model.info import (ConanInfo, RequirementsInfo, RequirementInfo,
                                       PythonRequiresInfo)
