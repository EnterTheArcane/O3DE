...
from thirdparty._internal.default_settings import migrate_settings_file
...
class ClientMigrator(Migrator):
    ...
    def _apply_migrations(self, old_version):
        ...
        from thirdparty._internal.graph.compatibility import migrate_compatibility_files
        migrate_compatibility_files(self.cache_folder)
        # Update profile plugin
        from thirdparty._internal.api.profile.profile_loader import migrate_profile_plugin
