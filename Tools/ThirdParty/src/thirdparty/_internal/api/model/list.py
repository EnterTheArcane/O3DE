...
from thirdparty._internal.model.refs import RecipeReference, PkgReference
...
from thirdparty._internal.graph.graph import RECIPE_EDITABLE, RECIPE_CONSUMER, RECIPE_PLATFORM, \
