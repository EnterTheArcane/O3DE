...
from thirdparty.tools.build.flags import architecture_flag, architecture_link_flag, libcxx_flags, threads_flags
from thirdparty.tools.build.cross_building import cross_building
from thirdparty.tools.cmake.toolchain import CONAN_TOOLCHAIN_FILENAME
...
class ExtraVariablesBlock(Block):
    ...
    def context(self):
        from thirdparty.tools.cmake.utils import parse_extra_variable
