...
from thirdparty.tools.cmake.layout import get_build_folder_custom_vars, is_consumer
from thirdparty.tools.cmake.toolchain.blocks import GenericSystemBlock
