...
class ClientMigrator(Migrator):
    ...
    def _apply_migrations(self, old_version):
        ...
        from conan2.internal.graph.compatibility import migrate_compatibility_files
        migrate_compatibility_files(self.cache_folder)
        # Update profile plugin
        from conan2.internal.api.profile.profile_loader import migrate_profile_plugin
