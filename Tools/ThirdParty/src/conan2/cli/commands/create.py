...
from conan2.cli.args import add_lockfile_args, add_common_install_arguments
from conan2.cli.command import conan_command, OnceArgument
from conan2.cli.commands.export import common_args_export
...
def create(conan_api, parser, *args):
    ...
    if test_conanfile_path and not install_error:
        ...
        from conan2.cli.commands.test import run_test
