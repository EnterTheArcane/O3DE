...
from conan2.tools.apple.apple import to_apple_arch, xcodebuild_deployment_target_key
from conan2.tools.apple.xcodedeps import GLOBAL_XCCONFIG_FILENAME, GLOBAL_XCCONFIG_TEMPLATE, \
