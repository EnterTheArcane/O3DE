...
from conan2.tools.microsoft import msvs_toolset
from conan2.tools.microsoft.visual import vs_installation_path, _vcvars_path, _vcvars_versions
from conan2.tools.qbs import common
