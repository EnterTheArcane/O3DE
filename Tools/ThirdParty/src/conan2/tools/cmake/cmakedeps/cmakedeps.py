...
from conan2.api.output import Color
from conan2.internal import check_duplicated_generator
from conan2.tools.cmake.cmakedeps import FIND_MODE_CONFIG, FIND_MODE_NONE, FIND_MODE_BOTH, \
    FIND_MODE_MODULE
from conan2.tools.cmake.cmakedeps.templates.config import ConfigTemplate
from conan2.tools.cmake.cmakedeps.templates.config_version import ConfigVersionTemplate
from conan2.tools.cmake.cmakedeps.templates.macros import MacrosTemplate
from conan2.tools.cmake.cmakedeps.templates.target_configuration import TargetConfigurationTemplate
from conan2.tools.cmake.cmakedeps.templates.target_data import ConfigDataTemplate
from conan2.tools.cmake.cmakedeps.templates.targets import TargetsTemplate
from conan2.tools.files import save
