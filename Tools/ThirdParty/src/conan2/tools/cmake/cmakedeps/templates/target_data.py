...
from conan2.tools.cmake.cmakedeps import FIND_MODE_NONE, FIND_MODE_CONFIG, FIND_MODE_MODULE, \
    FIND_MODE_BOTH
from conan2.tools.cmake.cmakedeps.templates import CMakeDepsFileTemplate
from conan2.errors import ConanException
from conan2.internal.api.install.generators import relativize_path
from conan2.tools.cmake.utils import cmake_escape_value
