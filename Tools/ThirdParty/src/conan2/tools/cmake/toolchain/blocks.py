...
from conan2.tools.apple.apple import get_apple_sdk_fullname, _to_apple_arch
from conan2.tools.android.utils import android_abi
from conan2.tools.apple.apple import is_apple_os, to_apple_arch
from conan2.tools.build import build_jobs
from conan2.tools.build.flags import architecture_flag, architecture_link_flag, libcxx_flags, threads_flags
from conan2.tools.build.cross_building import cross_building
from conan2.tools.cmake.toolchain import CONAN_TOOLCHAIN_FILENAME
from conan2.tools.cmake.utils import is_multi_configuration
from conan2.tools.intel import IntelCC
from conan2.tools.microsoft.visual import msvc_version_to_toolset_version, msvc_platform_from_arch
...
class ExtraVariablesBlock(Block):
    ...
    def context(self):
        from conan2.tools.cmake.utils import parse_extra_variable
