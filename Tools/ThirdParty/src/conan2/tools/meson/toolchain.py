...
from conan2.tools.apple.apple import is_apple_os, apple_min_version_flag, \
    resolve_apple_flags, apple_extra_flags
from conan2.tools.build.cross_building import cross_building, can_run
from conan2.tools.build.flags import (architecture_link_flag, libcxx_flags, architecture_flag,
                                     threads_flags)
from conan2.tools.env import VirtualBuildEnv
from conan2.tools.meson.helpers import get_apple_subsystem, to_cppstd_flag, to_cstd_flag, \
    to_meson_machine, to_meson_value
from conan2.tools.microsoft import VCVars, msvc_runtime_flag
