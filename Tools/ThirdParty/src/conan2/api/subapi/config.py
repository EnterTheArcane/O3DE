...
from conan2.internal.graph.graph import CONTEXT_HOST, RECIPE_VIRTUAL, Node
from conan2.internal.graph.graph_builder import DepsGraphBuilder
from conan2.internal.graph.profile_node_definer import consumer_definer
from conan2.errors import ConanException

from conan2.internal.model.conanconfig import loadconanconfig, saveconanconfig, loadconanconfig_yml
from conan2.internal.model.conf import BUILT_IN_CONFS
from conan2.internal.model.pkg_type import PackageType
from conan2.api.model import RecipeReference, Remote
from conan2.internal.util.files import rmdir, remove
...
class ConfigAPI:
    ...
    def install(self, path_or_url: str, verify_ssl, config_type=None, args=None,
        ...
        """
        from conan2.internal.api.config.config_installer import configuration_install
