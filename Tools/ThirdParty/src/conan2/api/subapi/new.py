...
class NewAPI:
    ...
    def get_builtin_template(template_name):
        from conan2.internal.api.new.basic import basic_file, basic_default_file
        from conan2.internal.api.new.alias_new import alias_file
        ...
        from conan2.internal.api.new.header_lib import header_only_lib_files
        from conan2.internal.api.new.meson_lib import meson_lib_files
        from conan2.internal.api.new.meson_exe import meson_exe_files
        from conan2.internal.api.new.msbuild_lib import msbuild_lib_files
        from conan2.internal.api.new.msbuild_exe import msbuild_exe_files
        from conan2.internal.api.new.bazel_lib import bazel_lib_files
        from conan2.internal.api.new.bazel_exe import bazel_exe_files
        from conan2.internal.api.new.bazel_7_lib import bazel_lib_files_7
        from conan2.internal.api.new.bazel_7_exe import bazel_exe_files_7
        from conan2.internal.api.new.autotools_lib import autotools_lib_files
        from conan2.internal.api.new.autoools_exe import autotools_exe_files
        from conan2.internal.api.new.premake_lib import premake_lib_files
        from conan2.internal.api.new.premake_exe import premake_exe_files
        from conan2.internal.api.new.local_recipes_index import local_recipes_index_files
        from conan2.internal.api.new.qbs_lib import qbs_lib_files
        from conan2.internal.api.new.workspace import workspace_files
