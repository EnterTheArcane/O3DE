...
class CommandAPI:
    ...
    def get_runner(profile_host):
        if profile_host.runner and not os.environ.get("CONAN_RUNNER_ENVIRONMENT"):
            from conan2.internal.runner.docker import DockerRunner
            from conan2.internal.runner.ssh import SSHRunner
            from conan2.internal.runner.wsl import WSLRunner
            try:
