...
ly_set(PAL_ARCHITECTURE_ARM FALSE)
ly_set(PAL_ARCHITECTURE_X64 FALSE)
if("${LY_ARCHITECTURE_NAME_EXTENSION}" STREQUAL "_aarch64" OR "${LY_ARCHITECTURE_NAME_EXTENSION}" STREQUAL "_arm64")
    ly_set(PAL_ARCHITECTURE_ARM TRUE)
elseif("${LY_ARCHITECTURE_NAME_EXTENSION}" STREQUAL "_x86_64" OR "${LY_ARCHITECTURE_NAME_EXTENSION}" STREQUAL "")
    # x86_64 is the default when no architecture extension is set
    ly_set(PAL_ARCHITECTURE_X64 TRUE)
endif()
